...
=> [Link to React app](https://github.com/Bifabig/hello-react-front-end/tree/hello-rails-front-end)
...
```sh
  git clone https://github.com/Bifabig/hello-rails-back-end.git
```
